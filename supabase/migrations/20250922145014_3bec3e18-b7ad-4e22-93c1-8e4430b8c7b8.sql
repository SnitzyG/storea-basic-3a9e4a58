...
DROP FUNCTION IF EXISTS generate_rfi_number(uuid, text);
DROP FUNCTION IF EXISTS set_rfi_number();

-- Create improved RFI number generation function with proper security
