  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "table-row",
        head_cell: "text-muted-foreground rounded-md w-9 font-medium text-xs uppercase tracking-wide text-center py-2 bg-muted/30",
        row: "table-row",
        cell: cn(
          "table-cell relative p-0 text-center text-sm",
          "w-9 h-10 sm:h-12",
