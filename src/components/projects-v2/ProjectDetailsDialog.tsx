...
import { MapPin, Calendar, DollarSign, Users, Building, Clock, Trash2, Plus, UserMinus, Settings } from 'lucide-react';
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                {project.project_type && <Badge variant="outline">
                    {project.project_type.replace('_', ' ')}
                  </Badge>}
                {project.priority && <Badge variant={project.priority === 'high' ? 'destructive' : 'secondary'}>
                    {project.priority} priority
                  </Badge>}
              </div>
            </div>
            {isArchitect && <AlertDialog>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {project.address && <div className="flex items-start gap-2">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {project.estimated_start_date && <div>
                    ...
                    {project.estimated_finish_date && <div>
                    ...
                    {project.completion_percentage !== undefined && <div>
                ...
                {(project.homeowner_name || project.homeowner_email || project.homeowner_phone) && <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
