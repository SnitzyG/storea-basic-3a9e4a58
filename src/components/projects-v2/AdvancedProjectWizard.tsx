...
const PROJECT_TYPES = [
  { value: 'residential_new', label: 'Residential New Build', icon: Home },
  { value: 'residential_renovation', label: 'Home Renovation', icon: Home },
  { value: 'commercial_new', label: 'Commercial New Build', icon: Building2 },
  { value: 'commercial_renovation', label: 'Commercial Renovation', icon: Building2 },
  { value: 'industrial', label: 'Industrial Project', icon: Factory },
...
export const AdvancedProjectWizard = ({ open, onOpenChange, projectToEdit }: AdvancedProjectWizardProps) => {
  const [currentStep, setCurrentStep] = useState(1);
  const [loading, setLoading] = useState(false);
  const { createProject, updateProject } = useAdvancedProjects();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Reset form
      setFormData({
        name: '', description: '', project_type: 'residential_new', priority: 'medium',
        address: '', budget: '', square_footage: '', number_of_floors: '',
        estimated_start_date: undefined, estimated_finish_date: undefined,
        permit_status: 'not_required', homeowner_name: '', homeowner_email: '',
        homeowner_phone: '', collaborators: [], tags: [], weather_delays: '0',
        custom_fields: {}
      });
      setCurrentStep(1);
      onOpenChange(false);
                      ...
                      return (
                        <Card
                          ...
                          className={cn(
                            ...
                            formData.project_type === type.value ? "border-primary bg-primary/5" : ""
                          )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: ProjectUser['role']) => 
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('weather_delays', e.target.value)}
                    placeholder="0"
                    className="mt-1"
                  />
                </div>
                ...
                <Card className="mt-6">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {formData.estimated_start_date && formData.estimated_finish_date && (
                      <div className="flex justify-between">
