  ...
  public: {
    Tables: {
      ...
      error_breadcrumbs: {
        ...
        Relationships: [
          {
            foreignKeyName: "error_breadcrumbs_error_id_fkey"
            columns: ["error_id"]
            isOneToOne: false
            referencedRelation: "telemetry_errors"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      tender_package_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "tender_package_documents_tender_id_fkey"
            columns: ["tender_id"]
            isOneToOne: false
            referencedRelation: "tenders"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_db_performance_metrics: { Args: never; Returns: Json }
      get_system_health: {
        Args: never
        Returns: {
      ...
      get_user_activity_summary: { Args: { days_back?: number }; Returns: Json }
